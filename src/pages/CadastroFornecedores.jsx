...
function mapSupplierPayload(formData) {
  return {
    ...
    areaAtuacao: formData.areaAtuacao.trim()
  };
}
...
export default function CadastroFornecedores() {
  ...
  const handleAreaChange = (value) => {
    setFormData((current) => ({ ...current, areaAtuacao: value }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await sendSupplierForm(mapSupplierPayload(formData));
        ...
        <section className="cadastroforn-hero">
          ...
          <div className="cadastroforn-hero-content">
            ...
            <h1 className="cadastroforn-hero-title">
              <span className="cadastroforn-hero-title-gradient">Cadastro de Fornecedores</span>
            </h1>
            <p className="cadastroforn-hero-desc">Junte-se à nossa rede de parceiros e cresça conosco.</p>
          </div>
        </section>
          ...
          <div className="cadastroforn-container">
              ...
              <CardContent>
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: "200px" }}>
                    <h4 style={{ fontWeight: "bold", color: "#1e293b", marginBottom: "0.25rem" }}>
                      Manual de Conduta e Homologação
                    </h4>
                    <p style={{ fontSize: "0.9rem", color: "#64748b" }}>PDF - Leitura Obrigatória</p>
                  </div>
                  <Button
                    variant="outline"
                    onClick={() => window.open(manualFornecedorPDF, "_blank")}
            ...
            <Card className="cadastroforn-card">
              <CardHeader>
                ...
                <p className="cadastroforn-form-desc">Preencha o formulário para iniciar o processo de homologação.</p>
              </CardHeader>
              <CardContent>
                <form className="cadastroforn-form" onSubmit={handleSubmit}>
                  ...
                  <div className="cadastroforn-form-grid">
                    ...
                    <div>
                      ...
                      <Select value={formData.areaAtuacao} onValueChange={handleAreaChange} required>
                        <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Conte um pouco sobre sua empresa, diferenciais, etc."
                      rows={4}
                    />
                  </div>
                  {status.message ? (
                    <p className={`cadastroforn-feedback cadastroforn-feedback-${status.type === "success" ? "success" : "error"}`}>
                      {status.message}
                    </p>
                  ) : null}
                  <div className="cadastroforn-btn-wrap">
                    <Button className="cadastroforn-btn" type="submit" disabled={isSubmitting}>
